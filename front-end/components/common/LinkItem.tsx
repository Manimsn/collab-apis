...
const LinkItem = ({
  ...
  return (
    <Link
      href={NavLink}
      onClick={handleClick}
      className={`relative flex px-6 py-2 text-base lg:text-xs text-body-color group-hover:text-dark dark:text-dark-6 dark:group-hover:text-white  lg:inline-flex lg:py-6 lg:pl-0 lg:pr-4 ${
        dropdown &&
