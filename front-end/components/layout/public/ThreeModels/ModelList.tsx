...
const Checkout2 = () => {
  return (
    <section className="bg-gray-2 pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-0">
...
const CartItem = ({ img, title, subtitle, price }: any) => {
  return (
      ...
      <div className="mb-6">
        ...
        <div className="relative">
          <input
            ...
            className="w-full rounded-md border border-stroke bg-transparent px-5 py-3 font-medium text-body-color outline-none transition placeholder:text-dark-5 focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] dark:border-dark-3 dark:text-dark-6"
          />
          {cardNumber && (
...
const SelectGroup = ({ fullColumn, labelTitle }: any) => {
  return (
    <div className={`${fullColumn ? "w-full px-3" : "w-full px-3 md:w-1/2"}`}>
      <div className="mb-6">
        <label className="mb-2.5 block text-base font-medium text-dark dark:text-white">
        ...
        <div className="relative">
          <select className="w-full appearance-none rounded-md border border-stroke bg-transparent px-5 py-3 font-medium text-dark-5 outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-[#F5F7FD] dark:border-dark-3">
...
const FormStep = ({ title, children }: any) => {
...
const ShippingOption = ({ name, id, img, price, title }: any) => {
  return (
...
const CheckboxGroup = ({ labelTitle }: any) => {
  return (
      ...
      <div className="mb-7">
        ...
        >
          <div className="relative">
            ...
            <div className="box mr-4 flex h-5 w-5 items-center justify-center rounded bg-primary">
