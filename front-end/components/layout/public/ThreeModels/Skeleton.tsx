...
export default function Skeleton2() {
  return (
    <section
      ...
      className="w-[250px] bg-white py-0 dark:bg-dark  animate-pulse"
    >
      <div className="container">
        <div className="mx-auto w-full max-w-[370px]">
          <div className=" flex h-[175px] w-full items-center justify-center rounded-xl bg-gradient-to-r from-gray-1 to-gray-4 text-secondary-color dark:from-dark-4 dark:to-dark-5">
            <svg
              width="28"
              height="31"
              viewBox="0 0 28 31"
